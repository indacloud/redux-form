...
var createFields = function createFields(structure) {
      ...
      value: function componentWillMount() {
        ...
        this.names.forEach(function (name) {
          return register(name, 'Field', function () {
            return _get(_find(_this2.props.validate, { name: name }), 'funcs', undefined);
          }, function () {
            return _get(_find(_this2.props.validate, { name: name }), 'funcs', undefined);
          });
        });
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (!plain.deepEqual(this.props.names, nextProps.names)) {
          ...
          nextProps.names.forEach(function (name) {
            return register(prefixName(context, name), 'Field', function () {
              return _get(_find(_this3.props.validate, { name: name }), 'funcs', undefined);
            }, function () {
              return _get(_find(_this3.props.validate, { name: name }), 'funcs', undefined);
            });
          });
  ...
  Fields.propTypes = {
    ...
    validate: PropTypes.arrayOf(PropTypes.shape({
      ...
      funcs: PropTypes.oneOfType([PropTypes.func, PropTypes.arrayOf(PropTypes.func)])
    })),
    warn: PropTypes.arrayOf(PropTypes.shape({
      name: PropTypes.string.isRequired,
      funcs: PropTypes.oneOfType([PropTypes.func, PropTypes.arrayOf(PropTypes.func)])
    })),
